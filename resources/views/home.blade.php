    ...
    <header>
        <div class="header-top">
            <div class="container d-flex justify-content-between align-items-center">
                <div class="logo">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPOZEERl2xcj81kJugJZLf1YOgoj8HQoSQ4A&s" alt="Logo" style="height: 50px;">
                </div>
        ...
        <div id="carouselBanner" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="https://upcontent.vn/wp-content/uploads/2024/07/mau-banner-thuc-pham-chuc-nang-10-1536x960.jpg" class="d-block w-100" alt="Banner 1">
                </div>
                <div class="carousel-item">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMBI-WATdPVclumHPGJK7zr0VQge4CcThdDmLpvMvUPjm4J--D3QRJ0B7tNvgq8pTQEoA&usqp=CAU" class="d-block w-100" alt="Banner 2">
                </div>
                <div class="carousel-item">
                    <img src="https://thanhnien.mediacdn.vn/Uploaded/hongkyqc/2022_09_06/image1-7363.jpeg" class="d-block w-100" alt="Banner 3">
                </div>
            </div>
                ...
                @foreach($offers as $index => $offer)
                    <div class="col-md-4 mb-4">
                        <div class="card offer-card">
                            @if($index === 0)
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQQVgJ08a48Il5kjDcrhB896yy0y7D9LjeTgA&s" class="card-img-top" alt="{{ $offer->title }}">
                            @elseif($index === 1)
                                <img src="http://img.lazcdn.com/g/ff/kf/S2aecb546a7e54da985982c9b5f06a3a8b.jpg_720x720q80.jpg" class="card-img-top" alt="{{ $offer->title }}">
                            @elseif($index === 2)
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWfMWhtOyU7hgr50GNmguKeVaZHesilhl0OA&s" class="card-img-top" alt="{{ $offer->title }}">
                            @else
                    ...
                    @foreach($products as $product)
                        <div class="col-md-3 mb-4">
                            <div class="card product-card">
                                <img src="{{ asset($product->image) }}" class="card-img-top" alt="{{ $product->name }}" style="width: 100%; height: auto; object-fit: contain;">
