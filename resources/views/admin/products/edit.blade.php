...
@section('content')
    ...
    <div class="main-content">
        ...
        <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="productImageFile" class="form-label">Upload ảnh mới</label>
                <input type="file" class="form-control" id="productImageFile" name="image_file" accept="image/*">
                @if($product->image)
                    <small class="form-text text-muted">Ảnh hiện tại: <img src="{{ asset($product->image) }}" alt="Current image" style="height: 50px; width: auto; object-fit: cover;"></small>
                @endif
            </div>
            <div class="mb-3">
